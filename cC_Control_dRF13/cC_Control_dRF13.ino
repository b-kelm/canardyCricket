...
void setup() {
  ...
  servo5.attach(servo5Pin, 1100, 2000);
  servo6.attach(servo6Pin, 1100, 2000);
...
void loop() {
  ...
  servo1.write(s1_command_PWM); // s1_command_PWMWrites PWM value to servo object
...
void armedStatus() {
  ...
  if ((channel_5_pwm < 1500) && (channel_3_pwm < 1070)) { //BK: changed to channel 3
    armedFly = true;
...
void getDesState() {
   ...
   */
  thro_des = (channel_3_pwm - 1000.0)/1000.0; //Between 0 and 1: BK changed channels
  roll_des = (channel_1_pwm - 1500.0)/500.0; //Between -1 and 1: BK changed channels
  pitch_des = (channel_2_pwm - 1500.0)/500.0; //Between -1 and 1: BK changed channels
  yaw_des = (channel_4_pwm - 1500.0)/500.0; //Between -1 and 1: BK changed channels
